...
### 我们需要给自己的网页定制一个logo 
 ...
 - 具体我们看老师的模板第一次提交内容(https://github.com/hanteng/hanteng.github.io/commit/cf9691a940e8d9527d64553501a90991e9c5f1ab),老师对图标的修改内容。
 - logo可以由ai做，导出png档
...
---
# 接下来
 - 引用代码填写完后，把刚刚压缩包的文件打开，直接把六个文件放入你的网页文件夹之中，位置观看老师提交内容(https://github.com/hanteng/hanteng.github.io/commit/cf9691a940e8d9527d64553501a90991e9c5f1ab)，不需要单独放入一个文件夹
