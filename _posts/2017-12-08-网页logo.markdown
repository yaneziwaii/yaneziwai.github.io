...
### 我们需要给自己的网页定制一个logo 
 ...
 - 把自己的logo的png档提交上去
 - [提交步骤一,看到这句话说明，图片加载不出来，麻烦你手动点击进去看]("https://github.com/treeice/PhotoForUrl/步骤一.png")
 - [提交步骤二，看到这句话说明，图片加载不出来，麻烦你手动点击进去看]("https://github.com/treeice/PhotoForUrl/步骤二.png")
 - [提交步骤三，看到这句话说明，图片加载不出来，麻烦你手动点击进去看]("https://github.com/treeice/PhotoForUrl/步骤三.png")
 - - 以下步骤，该模板以完成
 ...
 - - [提交步骤四，看到这句话说明，图片加载不出来，麻烦你手动点击进去看]("https://github.com/treeice/PhotoForUrl/步骤四.png")
 - - 然后打开_layout文件夹下的_default.html文件夹，把刚刚创建的favicon.html的文件加入网页之中，格式是大括号{\% \%}，里面填写引用代码的文件位置，这里是 include favicon.html 两个位置。
 - - [提交步骤五，看到这句话说明，图片加载不出来，麻烦你手动点击进去看]("https://github.com/treeice/PhotoForUrl/步骤五.png")
 - 以上步骤，该模板以完成
---
# 接下来
 ...
 + + favicon.ico
 + + manifest.json
 - [提交步骤六，看到这句话说明，图片加载不出来，麻烦你手动点击进去看]("https://github.com/treeice/PhotoForUrl/步骤六.png")
 - 然后logo就生成换好了。